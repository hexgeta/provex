  ...
  return (
    <button
      ...
      className={`px-6 py-3 rounded-t-xl font-semibold relative ${
        active
          ? 'bg-black border-2 border-b-0 border-gray-900 text-white z-10 mb-[-2px] after:content-[""] after:absolute after:bottom-[-2px] after:left-0 after:right-0 after:h-[2px] after:bg-black'
